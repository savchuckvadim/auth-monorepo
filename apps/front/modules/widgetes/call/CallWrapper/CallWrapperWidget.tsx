...
const CallWrapperWidgetContent: FC<{ children: React.ReactNode }> = ({
    ...
    const {
        ...
        myStream,
        remoteStream,
        remoteUserId, // ID пользователя на другом конце звонка
    ...
    // Получаем данные пользователя для отображения имени в remote video
    ...
    return (
        <div className="w-screen">
            ...
            {(() => {
                ...
                return isIncomingCall && (<CallIncoming />
...
export const CallWrapperWidget: FC<ICallWrapperWidgetProps> = ({
    ...
    // Теперь используем глобальный провайдер из network/layout.tsx
    return (
