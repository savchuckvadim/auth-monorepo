...
import { TotalUnreadMessagesBadge } from "@/modules/entities/messages";
...
interface NavItemProps {
    ...
    /** Unread badge (e.g. messages total) */
    badgeCount?: number;
}
export const NavItem = ({ label, href, type, isActive, badgeCount }: NavItemProps) => {
                            ...
                            : type === ENavigationType.MESSAGE
                                ? (
                                    <span className="relative inline-flex shrink-0">
                                        ...
                                        <TotalUnreadMessagesBadge variant="nav" />
                                    </span>
                                )
