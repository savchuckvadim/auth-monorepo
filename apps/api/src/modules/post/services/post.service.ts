...
export class PostService {
        ...
        if (wallUserId !== authorId) {
            ...
            if (!isFollowing) {
                throw new ForbiddenException(
                    'You can only post on walls of users you follow',
                );
            }
        }
    ...
    public async getPostsByUserId(
        ...
        const result = await this.repo.getByUserId(
            userId,
            currentUserId,
            cursor,
            limit,
    ...
    public async likePost(postId: string, userId: string): Promise<void> {
        ...
        this.eventEmitter.emit(
            PostEvent.LIKED,
            new PostLikedEvent(postId, userId, true),
        );
    }
    ...
    public async dislikePost(postId: string, userId: string): Promise<void> {
        ...
        this.eventEmitter.emit(
            PostEvent.LIKED,
            new PostLikedEvent(postId, userId, false),
        );
    }
